    ...
    : IClassFixture<LigaHubApiFactory>
{
    ...
    public DeleteOrganizationEndpointTests(
    ...
    [Fact]
    public async Task Delete_ShouldReturnNoContent_WhenOrganizationExists()
    {
    ...
    [Fact]
    public async Task Delete_ShouldReturnNotFound_WhenOrganizationDoesNotExist()
    {
        var id = Guid.NewGuid();
